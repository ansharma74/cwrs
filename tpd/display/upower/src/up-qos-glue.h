...
/* NONE:UINT,POINTER */
#define dbus_glib_marshal_up_qos_VOID__UINT_POINTER	g_cclosure_marshal_VOID__UINT_POINTER
#define dbus_glib_marshal_up_qos_NONE__UINT_POINTER	dbus_glib_marshal_up_qos_VOID__UINT_POINTER
