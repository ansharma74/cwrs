...
void
gdata_marshal_VOID__OBJECT_OBJECT_POINTER (GClosure     *closure,
...
gdata_marshal_STRING__OBJECT_STRING (GClosure     *closure,
                                     ...
                                     gpointer      marshal_data)
{
  typedef gchar* (*GMarshalFunc_STRING__OBJECT_STRING) (gpointer     data1,
                                                        gpointer     arg_1,
                                                        gpointer     arg_2,
                                                        gpointer     data2);
  register GMarshalFunc_STRING__OBJECT_STRING callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  gchar* v_return;
  ...
  callback = (GMarshalFunc_STRING__OBJECT_STRING) (marshal_data ? marshal_data : cc->callback);
