...
struct _GdmGreeterIface
{
  ...
  gboolean (*handle_select_language) (
    GdmGreeter *object,
    GDBusMethodInvocation *invocation,
...
void gdm_greeter_complete_select_language (
    GdmGreeter *object,
    GDBusMethodInvocation *invocation);
...
void gdm_greeter_call_select_language (
    GdmGreeter *proxy,
    const gchar *arg_language,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
...
gboolean gdm_greeter_call_select_language_finish (
    GdmGreeter *proxy,
    GAsyncResult *res,
    GError **error);

gboolean gdm_greeter_call_select_language_sync (
    GdmGreeter *proxy,
    const gchar *arg_language,
    GCancellable *cancellable,
    GError **error);
