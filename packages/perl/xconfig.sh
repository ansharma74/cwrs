...
cf_time='Mon Jul  1 10:29:07 IST 2013'
chgrp=''
chmod='chmod'
chown=''
clocktype='long'
...
config_argc='6'
config_args='--keeplog --mode=buildmini --build=x86_64-linux-gnu --buildarch=x86_64-pc-linux-gnu --target-name=x86_64-unknown-linux-gnu --target-arch=x86_64-unknown-linux-gnu'
contains='grep'
cp='cp'
cpio=''
cpp_stuff='42'
