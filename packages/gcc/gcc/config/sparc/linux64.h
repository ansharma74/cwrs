...
#define GLIBC_DYNAMIC_LINKER32 "/x86_64/lib/ld-linux.so.2"
#define GLIBC_DYNAMIC_LINKER64 "/x86_64/lib64/ld-linux.so.2"
...
#undef LINK_SPEC
#define LINK_SPEC "-m elf64_sparc -Y P,%R/x86_64/usr/lib64 %{shared:-shared} \
  %{!shared: \
    %{!static: \
      %{rdynamic:-export-dynamic} \
      -dynamic-linker " GNU_USER_DYNAMIC_LINKER64 "} \
