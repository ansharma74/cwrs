...
if [ `uname` == "Darwin" ];
then
  export DYLD_LIBRARY_PATH="/home/cos/source/cwrr/cwrs/images/ms/lib64/fakenect/:${LD_LIBRARY_PATH}"
else
  export LD_LIBRARY_PATH="/home/cos/source/cwrr/cwrs/images/ms/lib64/fakenect/:${LD_LIBRARY_PATH}"
fi
